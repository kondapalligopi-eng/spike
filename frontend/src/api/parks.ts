...
const DEFAULT_PARKS: Omit<ParkRead, 'id' | 'created_at' | 'updated_at'>[] = [
  ...
  { name: 'Indiranagar Defence Colony Park', locality: 'Indiranagar, Bengaluru',         rating: 4, image_url: '/parks/indiranagar.jpg',  address: 'Defence Colony, Indiranagar, Bengaluru 560038',                    hours: '5 am to 8 pm', cost: 'Free to use',                            off_leash: 'Yes, in designated areas',            features: 'Off-leash zone, Playground, Restrooms',   phone: null, email: null, website: null, highlights: DEFAULT_HIGHLIGHTS },
  { name: 'Bellandur Lake Park',             locality: 'Bellandur, Bengaluru',           rating: 4, image_url: '/parks/bellandur.jpg',    address: 'Bellandur, Bengaluru, Karnataka 560103',                           hours: '6 am to 7 pm', cost: 'Free to use',                            off_leash: 'On-leash only',                       features: 'Lake views, Walking trails',              phone: null, email: null, website: null, highlights: DEFAULT_HIGHLIGHTS },
  { name: 'Whitefield Memorial Park',        locality: 'Whitefield, Bengaluru',          rating: 4, image_url: '/parks/whitefield.jpg',   address: 'Whitefield, Bengaluru, Karnataka 560066',                          hours: '5 am to 9 pm', cost: 'Free to use',                            off_leash: 'Yes, in designated areas',            features: 'Walking trails, Benches, Off-leash zone', phone: null, email: null, website: null, highlights: DEFAULT_HIGHLIGHTS },
];
