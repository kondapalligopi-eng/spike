  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        ...
        <Link
          to="/dogs"
          className="inline-flex items-center gap-2 px-6 py-3 border-2 border-warm-300 bg-white text-warm-700 font-bold rounded-xl hover:border-primary-500 hover:text-primary-700 transition-colors"
        >
          Browse Dogs
        </Link>
      </div>
