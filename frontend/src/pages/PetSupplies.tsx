...
const PRODUCTS: Product[] = [
  {
    brand: 'Iams',
    name: 'Proactive Health Minichunks with Real Chicken & Whole Grains Dry Dog Food, 15-lb bag',
  ...
  {
    brand: 'Iams',
    name: 'Proactive Health Minichunks with Real Chicken & Whole Grains Dry Dog Food, 30-lb bag',
  ...
  {
    brand: 'ORIJEN',
    name: 'Original Grain-Free High-Protein Dry Dog Food, 31-lb bag',
  ...
  },
  {
    ...
    name: 'Salmon, Brown Rice & Vegetables Recipe Dry Dog Food, 28-lb bag',
  ...
  {
    brand: 'Pedigree',
    name: 'Adult Complete Nutrition Dry Dog Food with 36 Vitamins, Minerals & Amino Acids',
  ...
  },
  {
    ...
    name: 'Specialized Adult Sensitive Skin & Stomach Salmon & Rice Formula Dry Dog Food',
  ...
  {
    brand: 'Purina ONE',
    name: 'SmartBlend Chicken & Rice Formula Adult Dry Dog Food, 40-lb bag',
